...
ANIMATION_RIGHT = [('%s/wolf/r1.png' % ICON_DIR),
            ('%s/wolf/r2.png' % ICON_DIR),
            ('%s/wolf/r3.png' % ICON_DIR),
            ('%s/wolf/r4.png' % ICON_DIR),
            ('%s/wolf/r5.png' % ICON_DIR)]
ANIMATION_LEFT = [('%s/wolf/l1.png' % ICON_DIR),
            ('%s/wolf/l2.png' % ICON_DIR),
            ('%s/wolf/l3.png' % ICON_DIR),
            ('%s/wolf/l4.png' % ICON_DIR),
            ('%s/wolf/l5.png' % ICON_DIR)]
ANIMATION_JUMP_LEFT = [('%s/wolf/jl.png' % ICON_DIR, 0.1)]
ANIMATION_JUMP_RIGHT = [('%s/wolf/jr.png' % ICON_DIR, 0.1)]
ANIMATION_JUMP = [('%s/wolf/j.png' % ICON_DIR, 0.1)]
ANIMATION_STAY = [('%s/wolf/0.png' % ICON_DIR, 0.1)]
